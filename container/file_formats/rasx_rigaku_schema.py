...
class Root(BaseXmlModel, search_mode=SearchMode.UNORDERED):
    """XML elements of root.xml."""
...
class Category(BaseXmlModel, search_mode=SearchMode.UNORDERED):
...
class Distance(BaseXmlModel, search_mode=SearchMode.UNORDERED):
    """XML elements of MesurementConditions*.xml."""
...
class XrayGenerator(BaseXmlModel, BaseModel, search_mode=SearchMode.UNORDERED):
    """XML elements of MesurementConditions*.xml."""
...
class Detector(BaseXmlModel, search_mode=SearchMode.UNORDERED):
    """XML elements of MesurementConditions*.xml."""
...
class Optics(BaseXmlModel, search_mode=SearchMode.UNORDERED):
    """XML elements of MesurementConditions*.xml."""
...
class HWConfigurations(BaseXmlModel, search_mode=SearchMode.UNORDERED):
    """XML elements of MesurementConditions*.xml."""
...
class GeneralInformation(BaseXmlModel, search_mode=SearchMode.UNORDERED):
    """XML elements of MesurementConditions*.xml."""
...
class ScanInformation(BaseXmlModel, BaseModel, search_mode=SearchMode.UNORDERED):
    """XML elements of MesurementConditions*.xml."""
...
class MeasurementConditions(BaseXmlModel, search_mode=SearchMode.UNORDERED):
    """XML elements of MesurementConditions*.xml."""
